...
describe TaskBuilder do
  ...
  it "should print the right ouput for input 1" do
    expect(task_builder('sample_input_1.txt')).to eq (["2 book: 24.98", "1 music CD: 16.49", "1 chocolate bar: 0.85", "Sales Taxes: 1.50", "Total: 42.32"])
  end

  it "should print the right ouput for input2" do
    expect(task_builder('sample_input_2.txt')).to eq (["1 imported box of chocolates: 10.50", "1 imported bottle of perfume: 54.65", "Sales Taxes: 7.65", "Total: 65.15"])
  end
  it "should print the right ouput for input3" do
    expect(task_builder('sample_input_3.txt')).to eq (["1 imported bottle of perfume: 32.19", "1 bottle of perfume: 20.89", "1 packet of headache pills: 9.75", "3 imported box of chocolates: 35.55", "Sales Taxes: 7.90", "Total: 98.38"])
  end
end